...
public class ChessMatch {
	...
	// en passant 
	// (regra especial do xadrez que permite ao peão capturar um outro peão 
	// que acabou de passar por ele)
	...
	private void validateTargetPosition(Position source, Position target) {
		if (!board.piece(source).possibleMove(target)) {
			throw new ChessException("The chosen piece cannot be move to the target position");
		}
	}
